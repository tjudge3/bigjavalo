...
/**
 * The program demonstrates comparisons of numbers and strings.
 */
...
public class Compare3 {
    public static void main(String[] args)
    {
        ...
        {
         System.out.printf("sqrt(2) time sqrt(2) is not 2 but %.18f%n", x * x);
        }

        final double EPSILON = 1E-14;
        if (Math.abs(x * x - y) < EPSILON)
        {
           System.out.println("sqrt(2) time sqrt(2) is approximately 2");
        }
